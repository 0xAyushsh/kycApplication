...
async function updateCustomerDetail(bankName, userId, aadhar, name, dob) {
	let response;
	try {
		...
		try {
			...
			console.log(`\n**************** As ${bankName} client ****************`);
			console.log('\n--> Submit Transaction: UpdateCustomerDetail');
			result = await contract.submitTransaction('UpdateCustomerDetail',aadhar, name, dob, bankName);
			console.log(`<-- result: Successfully updated customer kyc details`);
			
			response = {
				success: true,
				message: 'Successfully updated customer kyc details'
			};
			return response;
		} catch (error) {
...
//updateCustomerDetail('sbibank','SBIManager,'1231231231231','Ayush','23-04-1998');
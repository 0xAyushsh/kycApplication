...
async function getCustomerDetail(bankName, userId, aadhar) {
	let response;
	try {
		...
		try {
			...
			console.log(`\n**************** As ${bankName} client ****************`);
			console.log('\n--> Submit Transaction: GetCustomerDetail');
			result = await contract.submitTransaction('GetCustomerDetail',aadhar);
...
//getCustomerDetail('sbibank','SBIManager,'1231231231231');